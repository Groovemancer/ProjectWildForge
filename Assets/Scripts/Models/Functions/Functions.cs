...
public class Functions
{
    ...
    public T Call<T>(string functionName, params object[] args)
    {
        ...
        {
            DebugUtils.LogChannel(ModFunctionsLogChannel, "'" + functionName + "' is not a LUA nor CSharp function!");
            return default(T);
        }
    }
    ...
    public void Call(List<string> functionNames, params object[] args)
    {
        ...
        for (int i = 0; i < functionNames.Count; i++)
        {
            ...
            {
                DebugUtils.LogErrorChannel(ModFunctionsLogChannel, "'" + functionNames[i] + "'  is not a LUA nor CSharp function!");
                continue;
            }
    ...
    public T CreateInstance<T>(string className, bool throwError, params object[] args)
    {
        ...
        {
            DebugUtils.LogChannel(ModFunctionsLogChannel, "'" + className + "' is not a LUA function nor is it a CSharp constructor!");
    ...
    private DynValue Call(string functionName, bool throwError, params object[] args)
    {
        ...
        {
            DebugUtils.LogChannel(ModFunctionsLogChannel, "'" + functionName + "' is not a LUA nor is it a CSharp function!");
