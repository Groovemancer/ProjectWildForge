...
public static class FunctionsManager
{
    ...
    /// <summary>
    /// Gets the structure Functions.
    /// </summary>
    /// <value>The structure Functions.</value>
    public static Functions Structure
    {
        get { return Get("Structure"); }
    }
    ...
    public static void Initialize()
    {
        ...
        actions.Add("Structure", new Functions());
