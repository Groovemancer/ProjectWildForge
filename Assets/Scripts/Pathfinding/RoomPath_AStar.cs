...
namespace ProjectWildForge.Rooms
{
    ...
    public class RoomPath_AStar
    {
        ...
        public RoomPath_AStar(Queue<Room> path)
        {
            ...
            {
                DebugUtils.LogWarningChannel("Path_AStar", "Created path with no tiles, is this intended?");
            }
        ...
        public RoomPath_AStar(World world, Room roomStart, Pathfinder.RoomGoalEvaluator isGoal, Pathfinder.RoomPathfindingHeuristic costEstimate)
        {
            ...
            {
                DebugUtils.LogErrorChannel("Path_AStar", "The starting tile isn't in the list of nodes!");
        ...
        public Room Dequeue()
        {
            if (path == null)
            {
                DebugUtils.LogErrorChannel("Path_AStar", "Attempting to dequeue from an null path.");
                return null;
            }

            if (path.Count <= 0)
            {
                DebugUtils.LogErrorChannel("Path_AStar", "Path queue is zero or less elements long.");
                return null;
            }
        ...
        public Room EndRoom()
        {
            ...
            {
                DebugUtils.LogChannel("Path_AStar", "Path is null or empty.");
                return null;
            }
