...
public class Path_TileGraph
{
    ...
    {
        DebugUtils.LogChannel("Path_TileGraph", "Entered Path_TileGraph");
        ...
        */
        ...
        DebugUtils.LogChannel("Path_TileGraph", "Created " + nodes.Count + " nodes.");
    ...
    private void GenerateEdgesByTile(Tile t)
    {
        ...
        Tile[] neighbours = t.GetNeighbors(true, true);
